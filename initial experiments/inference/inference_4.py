...
def get_args():
    ...
    # Pointing to the CLIP model weights
    parser.add_argument("--model_path", type=str, default="best_cross_modal_clip.pth")
...
# ==========================================
# Use CLIP's specific transform logic manually to ensure consistency
...
def extract_features(model, v_dir, a_dir):
    ...
    print("--- Extracting Features (CLIP + Cnn14) ---")
    with torch.no_grad():
...
def plot_joint_tsne(v_feats, a_feats, v_labels, a_labels, class_names):
    ...
    plt.title("Joint t-SNE (CLIP + Cnn14): Vision (▲) vs Audio (●)")
    plt.tight_layout()
    plt.savefig("clip_cnn14_tsne_joint.png")
    print("Saved clip_cnn14_tsne_joint.png")
    return reduced 
...
def plot_class_subplots(reduced_all, v_labels, a_labels, class_names):
    ...
    plt.tight_layout()
    plt.savefig("clip_cnn14_tsne_subplots.png", dpi=300)
    print("Saved clip_cnn14_tsne_subplots.png")
...
def main():
    ...
    print("\n" + "="*40)
    print("   FINAL RETRIEVAL RESULTS (CLIP + Cnn14)")
    print("="*40)
    ...
    plot_single_confusion(
        ...
        class_names=classes, 
        title="Image-to-Audio (CLIP + Cnn14)", 
        filename="clip_cnn14_confusion_img2aud.png",
    ...
    plot_single_confusion(
        ...
        class_names=classes, 
        title="Audio-to-Image (CLIP + Cnn14)", 
        filename="clip_cnn14_confusion_aud2img.png",
