...
class VisionEncoder(nn.Module):
    def __init__(self, embedding_dim=128):
        ...
        # Keep AvgPool (no params) and drop the original fc
...
class AudioEncoder(nn.Module):
    def __init__(self, embedding_dim=128):
        ...
        # Cnn14 structure: conv_block1 -> ... -> conv_block6 -> pooling
        if hasattr(self.base_model, 'conv_block6'):
            for param in self.base_model.conv_block6.parameters():
                param.requires_grad = True
        else:
            print("Warning: conv_block6 not found, check Cnn14 definition.")
...
def main():
    ...
    # Load Original Weights (for the parts we haven't trained yet)
    ...
    best_avg_r5 = 0.0
    print(f"--- Starting Fine-Tuned (Unfrozen) Training ---")
